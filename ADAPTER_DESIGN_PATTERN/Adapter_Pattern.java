...
class MediaAdapter implements MediaPlayer {
    ...
    public void play(String type, String filename) {
        ...
        else amp.playAVI("Tose Naina Jabse Mile.avi");
    }
}
...
// MATHCALCULATELIBRARY ( Adaptee )  , public int calculate AVG, minimum , maximum  public void sort data , adaptable system
//  